...
const (
	AuthenticationOK                AuthenticationResponseType = 0
	AuthenticationKerberosV5        AuthenticationResponseType = 2
	AuthenticationCleartextPassword AuthenticationResponseType = 3
	AuthenticationMD5Password       AuthenticationResponseType = 5
	AuthenticationSCMCredential     AuthenticationResponseType = 6
...
func MD5Msg(dst []byte, password string) []byte {
	dst = dst[:0]
